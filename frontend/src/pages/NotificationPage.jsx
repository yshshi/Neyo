...
const NotificationsPage = () => {
  ...
  const acceptedRequests = friendRequests?.already_accepted || [];
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-3">
                  {incomingRequests.map((request) => (
                    <div
                      key={request._id}
                      className="card bg-gray-900 text-amber-50 shadow-sm hover:shadow-md transition-shadow"
                    >
              ...
              <section className="space-y-4">
                ...
                <div className="space-y-3">
                  {acceptedRequests.map((notification) => {
                    ...
                    return (
                    <div key={notification._id} className="card text-amber-50 bg-gray-900 shadow-sm">
                      <div className="card-body p-4">
